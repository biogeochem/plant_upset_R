...
buoy_2021 <- read_csv(here("data/clean_data/Buoy_2021.csv"))

events <- read_csv(here("data/raw_data/Rising Floc Events 2021.xlsx"))
...
### 2021
```{r 2021, echo=FALSE, warning=FALSE}
...
plot(BUOY2021, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```


### June Event 1
```{r June Event 1, echo=FALSE, warning=FALSE}
...
plot(Jun14, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```


### June Events 2 + 3
```{r June Events 2 + 3, echo=FALSE, warning=FALSE}
...
plot(Jun21_22, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```

### June Events 4, 5, + 6
```{r June Events 4, 5, + 6, echo=FALSE, warning=FALSE}
...
plot(Jun25_26_27, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```

### July Events 1 + 2
```{r July Events 1 + 2, echo=FALSE, warning=FALSE}
...
plot(Jul01_02, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```

### July Events 3 + 4
```{r July Events 3 + 4, echo=FALSE, warning=FALSE}
...
plot(Jul03_04, units="in", width=8, height=8, dpi = 300, compression = "lzw")

```

### July Events 5, 6 + 7
```{r July Events 5, 6 + 7, echo=FALSE, warning=FALSE}
...
plot(Jul25_27, units="in", width=8, height=8, dpi = 300, compression = "lzw")
